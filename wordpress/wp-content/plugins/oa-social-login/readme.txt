...
Tags: social login, social networks, login, register, comment, social network login, social media login, buddypress, facebook, google, openid, twitter, linkedin, instagram, pinterest, instagram, vkontakte, github, steam, dribbble, twitch.tv
...
Social Login is a **professionally developed** and free Wordpress plugin that allows your visitors to **comment, login and register with 30+ Social Networks**.

**Seamlessly Integrates**<br />
Social Login is fully customizable and seamlessly integrates with your existing WordPress login/registration system so that your users don't have to start from scratch. 

Existing existing accounts can add/remove their social media accounts in their WordPress profile settings and then also use the linked social networks to login.

The plugin can also import the user's social network picture and set it up as user avatar on your blog. This feature can be disabled in the settings of the plugin. 
...
Social Login increases registration rates by up to 50% and provides permission-based access to users' social media profile data, allowing you to start delivering a personalized experience.

**Robust and Maintenance Free**<br />
Do not take the risk of loosing any users or customers due to outdated social network integrations. 

Unlike other Social Login providers we monitor the APIs and technologies of the different social networks and update our service as soon as changes arise.
...
Social Login used the standard WordPress hooks and includes many actions and filters allowing you to fully adapt the plugin to your needs.

A complete documentation is available here: [Social Login Actions, Hooks & Filters](http://docs.oneall.com/plugins/guide/social-login-wordpress/#3).

**30+ Social Networks Supported**
...
The OneAll API unifies 30+ Social Networks and consolidates the most powerful social network features in a single solution. 

You can work with multiple social networks at once and you will obtain a standardized field structure for data received from any of the social networks. Save time and development resources and focus on your core business. 
...
<em>The plugin in is one of the best I've seen so far. Extremely easy to implement and run. The support is great too. No concerns on my side. Keep it up!</em>
<strong>livia</strong>

<em>Loving the service, seen a massive increase in painless signups to my blog. Thanks!</em>
<strong>Richard B.</strong>

<em>You have no idea how it THRILLED me to integrate oneall. It was SO amazingly easy, your team has simplified the whole process of signing up for authorization on multiple social media sites. I HAD NO QUESTIONS/STEPS THAT YOU HADN'T ALREADY ANTICIPATED. It saved me HOURS of work!</em>
...
<em>I found it extremely straightforward. I just figured it out easily and make my website capable of connecting to many social networks by your plugin.</em>
<strong>Deha K.</strong>

<em>Just wanted to let you know how happy i am that i stumbled onto your service. This was the 6 Facebook/Twitter integration i tried and was starting to loose hope that i could actually find one that worked for me.</em>
...
<em>The service is excellent for what i need, simple to set up. All situations about seting up are well explained, so there are no difficulties</em>
...
<em>It was extremely easy to set up and use.  The documentation to set up the FB and twitter API was easy to follow and implement. I was struggling with a couple of other plugins till I stumbled on this one.</em>
...
<em>I especially enjoy the step by step process that guides you through the Social website App creation process. In the end I would like to thank you for putting together such a great product that so many users can implement with ease.</em>
